      ...
      if (mounted) {
        ...
        setState(() {
          ...
          if (_warehouses.isNotEmpty) {
            ...
            _toWarehouse = _warehouses.length > 1
                ? _warehouses[1] as Map<String, dynamic>
                : null;
          }
  ...
  Future<void> _handleTransfer() async {
    ...
    if (_selectedProduct == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Mahsulotni tanlang!')));
      return;
    }
    if (_fromWarehouse == null || _toWarehouse == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Ikkala omborni ham tanlang!')),
      );
      return;
    }
    if (_fromWarehouse!['id'] == _toWarehouse!['id']) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Manba va maqsad ombor bir xil bo\'lmasligi kerak!'),
        ),
      );
      return;
    }
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              ...
              content: Text(
                'Mahsulot omborlar orasida muvaffaqiyatli ko\'chirildi!',
              ),
            ),
          );
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<Map<String, dynamic>>(
                            ...
                            isExpanded: true,
                            validator: (v) => v == null
                                ? 'Manba ombor tanlanishi majburiy!'
                                : null,
                            decoration: const InputDecoration(
                          ...
                          DropdownButtonFormField<Map<String, dynamic>>(
                            ...
                            isExpanded: true,
                            validator: (v) => v == null
                                ? 'Maqsad ombor tanlanishi majburiy!'
                                : null,
                            decoration: const InputDecoration(
